...
- **VNPay/Casso/Sepay**: trạng thái giao dịch thanh toán
...
- **Mã hoá**:
  ...
  - Ảnh CCCD: encrypted at rest trên Cloudinary, signed URLs với TTL ngắn
- **Thời gian lưu**:
  ...
  - KYC images: 5 năm sau khi tài khoản xoá (theo quy định AML/KYC VN)
  - Crash logs: 90 ngày
...
| **VNPay** | Số tiền, mã giao dịch, email user (cho receipt) | Xử lý thanh toán |
| **Casso/Sepay** | Số tiền, mã tham chiếu | Đối soát chuyển khoản ngân hàng |
| **Cloudinary** | Ảnh CCCD, ảnh property | Lưu trữ + CDN |
...
- VNPay/Casso/Sepay: payment transaction status
...
- KYC images: 5 years after account deletion (Vietnamese AML/KYC law)
- Crash logs: 90 days
...
- VNPay — transaction amount, reference code, email
- Casso/Sepay — transaction reference for bank reconciliation
- Cloudinary — images for storage and CDN
