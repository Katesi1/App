            ...
            _Section(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: AppSpacing.sm),
                  _Field(ctrl: _codeCtrl, label: 'Mã căn *', hint: 'VD: C3-06',
                      validator: (v) =>
            ...
            _Section(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(child: _Field(ctrl: _standardGuestsCtrl,
                          label: 'Tiêu chuẩn', hint: 'VD: 10',
                          keyboard: TextInputType.number)),
                      const SizedBox(width: AppSpacing.md),
                      Expanded(child: _Field(ctrl: _maxGuestsCtrl,
                          label: 'Tối đa', hint: 'VD: 20',
                          keyboard: TextInputType.number)),
                    ],
                  ),
                  const SizedBox(height: 6),
                          ...
                          Wrap(
                            ...
                            children: g.value.map((a) {
                              ...
                              return GestureDetector(
                                onTap: () => setState(() {
                                  on ? _selectedAmenities.remove(a)
